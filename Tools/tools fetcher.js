...
if (window.location.search.substr(1) == 'quirytool=ehsaas') {
    if (id('webtool-place') != null) {
        let webtoolcon = '<iframe src="https://ehsaastracking.pass.gov.pk/" frameborder="0" class="ehsaas-frame fix top-0 right-0 left-0 bottom-0 index-999 margin-0"></iframe>';
        id('webtool-place').innerHTML = webtoolcon;
        setTimeout(() => {
